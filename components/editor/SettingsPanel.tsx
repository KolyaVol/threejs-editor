        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="border-t border-zinc-700 pt-6">
            ...
            <div className="mb-4">
              ...
              <p className="text-xs text-zinc-500">
                When enabled, objects will snap to rotation steps when rotated (hold Ctrl to rotate in translate mode)
              </p>
            </div>
          ...
          <div className="border-t border-zinc-700 pt-4">
            ...
            <p className="text-xs text-zinc-500">
              Hold <kbd className="px-1 py-0.5 bg-zinc-700 rounded text-xs">Ctrl</kbd> while in translate mode to temporarily switch to rotation mode.
            </p>
          </div>
        </div>
      </div>
